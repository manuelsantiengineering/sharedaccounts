...
void Test::testAll(){
  ...
  try{
    ...
    if(this->testPerson()){
      std::cout << "\n\t SUCCESS TESTING: " << "Person" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl << std::endl;
    }else{
      std::cout << "\n\t FAILED TESTING: " << "Person" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl;
      std::cout << "\t\t failed tests: " << this->failedTests << std::endl << std::endl;
    }
    ...
    this->failedTests = 0;
    if(this->testMoney()){
      std::cout << "\n\t SUCCESS TESTING: " << "Money" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl << std::endl;
    }else{
    ...
    this->failedTests = 0;
    if(this->testMyDate()){
      std::cout << "\n\t SUCCESS TESTING: " << "MyDate" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl << std::endl;
    }else{
    ...
    this->failedTests = 0;
    if(this->testMyTime()){
      std::cout << "\n\t SUCCESS TESTING: " << "MyTime" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl << std::endl;
    }else{
    ...
    this->failedTests = 0;
    if(this->testMyClock()){
      std::cout << "\n\t SUCCESS TESTING: " << "MyClock" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl << std::endl;
    }else{
    ...
    if(this->testMyString()){
      std::cout << "\n\t SUCCESS TESTING: " << "MyString" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl << std::endl;
    }else{
    ...
    if(this->testTimeAndDate()){
      std::cout << "\n\t SUCCESS TESTING: " << "TimeAndDate" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl << std::endl;
    }else{
    ...
    this->failedTests = 0;
    if(this->testPeriod()){
      std::cout << "\n\t SUCCESS TESTING: " << "Period" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl << std::endl;
    }else{
      std::cout << "\n\t FAILED TESTING: " << "Period" << std::endl;
      std::cout << "\t\t Passed tests: " << this->passedTests << std::endl;
      std::cout << "\t\t failed tests: " << this->failedTests << std::endl << std::endl;
    }
    this->totalPassedTests+= this->passedTests;
...
bool Test::testPeriod(){

  try{

    std::cout << std::endl << "Testing Period object" << std::endl;
    ...
    if(expected.testConstructor(p3,sdate,edate,stime,etime)) {this->passedTests++;}else{this->failedTests++;}
    MyDate testSdate(1,1,1990);
    MyDate testEdate(1,1,1990);
    if(expected.testConstructor(p4,testSdate,testEdate,stime,etime)) {this->passedTests++;}else{this->failedTests++;}
    if(expected.testConstructor(p5,std.getDate(),etd.getDate(),std.getTime(),etd.getTime())) {this->passedTests++;}else{this->failedTests++;}
    if(expected.testConstructor(p6,sdate,edate,stime,etime)) {this->passedTests++;}else{this->failedTests++;}
    testStime.setTime(12,0,0,true);
    testEtime.setTime(12,0,0,true);
    testSdate.setDate(1,1,1990);
  ...
  testSdate.setDate(5,3,2018);
  testEdate.setDate(5,3,2018);
  ...
  // std::cout << "02Now: " << p1.getTimeDateToday_UTC() << " P2 end: " <<  p2.getEndTimeAndDate() << std::endl;
